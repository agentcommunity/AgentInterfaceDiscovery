    ...
    <div className="w-full max-w-2xl px-4 mt-2 text-center">
      <div className="mb-3">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
            ...
            <Button variant="outline" size="sm" onClick={() => handleExampleClick('edge.aid.agentcommunity.org')}>edge-case</Button>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 justify-center">
             <Button variant="outline" size="sm" onClick={() => handleExampleClick('auth0.agentdomain.xyz')} className="border-primary/50 hover:bg-primary/10 text-primary hover:text-primary">
                <Star size={12} className="mr-2 fill-current" />
                auth0-mcp
            </Button>
            <Button variant="outline" size="sm" onClick={() => handleExampleClick('supabase.agentdomain.xyz')} className="border-primary/50 hover:bg-primary/10 text-primary hover:text-primary">
                <Star size={12} className="mr-2 fill-current" />
                Supabase
            </Button>
        </div>
