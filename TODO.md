...
3.  **[P1] Publish Canonical Schema (`@agentcommunity/aid-schema`, PRD-3):**
    - Create the simple `@agentcommunity/aid-schema` package.
...
6.  **Release v0.1.0:**
    - Use `changesets` to version, publish, and tag the first official release of `@aid/core`, `@aid/conformance`, and `@agentcommunity/aid-schema`.
